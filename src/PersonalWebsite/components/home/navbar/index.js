        ...
        <div class="px-3 py-2 bg-dark text-white">
            <div class="container">
                <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                    <Link to="home" class="fs-1 d-flex align-items-center my-2 my-lg-0 me-lg-auto text-white text-decoration-none">
                        <img src="/resources/logo.png" class="rounded-circle" width="44" height="44" role="img" aria-label="Bootstrap"></img>
